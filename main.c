...
#define CROM_TILE_START_TOMBE1 45 // 2
#define CROM_TILE_START_TOMBE2 47 // 2
#define CROM_TILE_START_TOMBE3 49 // 2
#define CROM_TILE_START_HERBE 51 // 32
#define CROM_TILE_START_LANCE1 83 // 2
#define CROM_TILE_START_LANCE2 85 // 2
#define CROM_TILE_START_LANCE3 87 // 2
